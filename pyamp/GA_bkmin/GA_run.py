...
def main():
    ...
    parser.add_argument('init_pop', default = 'random', choices=['random','reference','ongoing'], help='"random" or "reference" from GANNtest file')
    parser.add_argument('job', choices=['qsub','csh'], help='Select between node and login server')
    ...
    if args.init_pop == 'random': 
        ...
        for i in range(num_pop):
           ...
           os.mkdir(dir_name)
           os.system("cp "+fin[0]+" amp_ga.py my* GA.py "+copy_name)

    elif args.init_pop == 'reference':
