...
import argparse
import re
from my_mplot2d import mplot_nvector
...
def main():
    ...
    parser.add_argument('-xt', '--xtitle', default='t(ps)', help='X title')
    parser.add_argument('-yt', '--ytitle', default='E(kJ/mol)', help='Y title')
