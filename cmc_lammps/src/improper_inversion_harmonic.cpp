...
void ImproperInversionHarmonic::invang(const int &i1,const int &i2,const int &i3,const int &i4,
          ...
          const double &rrvb3, const double &rr2vb3)
{
  ...
  double omega,cosomega,domega,gomega,rjk,rjl,upx,upy,upz,upn,rup,umx,umy,umz,umn,rum,wwr;
