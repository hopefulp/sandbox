...
#RUNBIN="$HOME/00.Development/0.GitHub/1.MSDFT/Local/ms-dft/Obj/transiesta"
#RUNBIN="$HOME/opt/siesta-4.1-b4_MS-DFT_ver3/Obj_fixed_rho/transiesta"
#RUNBIN="$HOME/bin/msdft_exec/metagga_0.3v"
RUNBIN="siesta"
...
cd ${rundir}
   ...
   mpirun -np $NPROCS ${MPIARG} -env I_MPI_FABRICS="shm:tcp"  ${RUNBIN}  < ${RUN_FDF} > stdout.txt
