...
### in case: pf = logspace, $pmm is required
#set Gs = "-f $fname -j $pyjob -tef -hl $hl -el $el -fl $fl -nc $nc -nt $nt -ntr $ntr -dtype $dtype -dl $dlist -des $des -pf $pf -pmm $pmm -pn $pn -g"
set Gs_des = "-f $fname -j $pyjob -tef -hl $hl -el $el -fl $fl -nc $nc -nt $nt -ntr $ntr -dtype $dtype -dl $dlist -des $des -pf $pf -pn $pn -g"
set Gs     = "-f $fname -j $pyjob -tef -hl $hl -el $el -fl $fl -nc $nc -nt $nt -ntr $ntr -dtype $dtype -dl $dlist -g"
