...
class NeuralNetwork(Model):
    ...
    def fit(self,
        ...
        #log('max_iterations = {max_iterations} in NN.fit()')
        #print(f'max_iterations = {max_iterations} in NN.fit()')
        if self.regressor is None:
            self.regressor = Regressor(max_iterations = max_iterations)
    ...
    def forcetraining(self):
        ...
        returns False.
        """
        #print("jp: forcetraining runs after _initialize of LossFunction")
