...
def calc_ga(job_submit, exe, fin, fout,ndata, max_iter, setup, nchromo, nhl, nnode, ngenerations, igen, nparent_sets, mutation_percent, Lcheck_string, Ltest):
    ...
    ### igen: index of start generation
    ###
    calc.run_generation(job_submit=job_submit, dir_prefix=subdir_prefix, istart=igen,
...
def main():
    ...
    genetic_params.add_argument('-ig', '--igeneration', default=0, type=int, help="start index of generation")
    ...
    if args.usage:
        ...
        sys.exit(0)
    calc_ga(args.job_submit,args.exe,args.ifile,args.ofile,args.ndata,args.max_iter,args.ini_setup,args.nchromo,args.hlayers,args.nnodes,args.ngenerations,args.igeneration,args.nparents_sets,args.prob_mutation, args.check_string, args.Ltest)
    return 0
