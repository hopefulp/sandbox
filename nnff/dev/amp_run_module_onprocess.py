...
def import_module(mod):
    if mod == 'master':
        ...
        amp = importlib.import_module('amp_dev')
...
def main():
    ...
    parser.add_argument('-m', '--mod', default='master', choices=['master', 'dev'], help='select amp module in master|dev')
    ### Descriptor group
