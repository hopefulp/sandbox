...
amp.amp_jobs            =" amp_jobs.sh job\
                        \n\t\t:run scripts by job-case\
                        \n\t\tjob: fp wrapper wrapper_subdir te subdir sh chmod\
                        \n\t\t    fp: \
                        \n\t\t\tamp_mkdir.py $dname -w amp -j db\
                        \n\t\t    wrapper: run amp_wrapper.py in dirs\
                        \n\t\t    wrapper_subdir: run amp_wrapper.py in subdirs\
                        "
amp.amp_mkdir        =  " new_dir [old_dir] -w amp pbs -j tr\
