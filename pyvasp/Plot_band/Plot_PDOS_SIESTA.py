...
fig1.fill_between(T_x,T_yd,0,color='orange')
fig1.fill_between(T_x,T_yu,0,color='red')
fig1.fill_between(T_x,sig_yd,0,color='chartreuse')
fig1.fill_between(T_x,sig_yu,0,color='g')
