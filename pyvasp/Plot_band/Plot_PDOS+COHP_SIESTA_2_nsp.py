...
Pr_Gr = glob.glob('/home/softmax1986/Paper/Graphene_D_doped/7X7/Single_point_cal/Band_cal/Pr_Gr/Pr_Pz.dat')
...
#fig2.plot(c1_yd, c_x, lw=4, color ='black',dashes=(15,10))
fig2.plot(c2_yu, c_x, lw=12, color ='red',dashes=(40,10))
#fig2.plot(c2_yd, c_x, lw=4, color ='blue',dashes=(15,10))
#fig2.plot(c3_yu, c_x, lw=4, color ='c')
#fig2.plot(c3_yd, c_x, lw=4, color ='c',dashes=(15,10))
