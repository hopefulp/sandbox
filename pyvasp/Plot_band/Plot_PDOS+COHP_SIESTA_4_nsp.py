...
for i in f8.readlines():
    list_lines = i.split()
    cohp_d4_up.append(float(list_lines[1]))
#    cohp_d3_down.append(float(list_lines[2]))
...
#COHP data Plot
fig2.plot(c1_yu, c_x, lw=12, color ='blue')
#fig2.plot(c1_yd, c_x, lw=6, color ='black',dashes=(15,10))
#fig2.plot(c2_yu, c_x, lw=12, color ='red',dashes=(40,10))
#fig2.plot(c2_yd, c_x, lw=6, color ='blue',dashes=(15,10))
fig2.plot(c3_yu, c_x, lw=12, color ='g',dashes=(40,10,10,10))
#fig2.plot(c3_yd, c_x, lw=6, color ='c',dashes=(15,10))
fig2.plot(c4_yu, c_x, lw=12, color ='m',dashes=(40,10,10,10,10,10))
