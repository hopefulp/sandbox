...
def make_vasp_dir(job, poscar, poscar_sub, apotcar, kpoints, incar, allprepared, Lquestion, kpsub, dirname, iofile, atoms, Lrun, qopt):
...
def main():
    ...
    parser.add_argument('-j', '--job', default="opt", choices=["dos","band","pchg","chg","md","ini","lda","zpe","mol","wav","opt","sp", 'noD'], help='inquire for each file')
    ...
    parser.add_argument('-ss', '--poscar_sub', help='poscar in directory')
    ...
    make_vasp_dir(args.job, args.poscar, args.poscar_sub, args.potcar, args.kpoints, args.incar, args.all, args.question, args.kpsub, args.dname, args.iofile, args.atoms, args.run, args.qopt)
    return 0
