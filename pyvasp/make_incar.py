...
def main():
    ...
    parser.add_argument('-c', '--crelax', default='atom', choices=['sp', 'atom', 'cell'], help='atom/cell relaxation')
    ...
    parser.add_argument('-md', '--dynamics', default=None, choices=['nvt', 'npt'], help='molecular dynamics flavor')
