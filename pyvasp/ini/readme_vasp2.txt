...
get_Procar.pl PROCAR energy1[energy2]
	: get_procar was changed to get_Procar and 
	: which shows the energy +- del_energy with k, band when pdos is over a certain value
	: all the parameters are modified in the source
	: output: energy kpoint band pdos[Me] pdos[CO2]
