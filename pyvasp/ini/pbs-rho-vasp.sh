...
MPI="/opt/mpi/intel-12/openmpi-1.8.1/bin/mpirun -np $NPROC -hostfile $PBS_NODEFILE"
EXEC="/opt/applic/vasp/bin/vasp-5.3.3-xe11-static-mvapich2-1.9-full"
#EXEC="/opt/applic/vasp/bin/vasp-5.3.3-xe11-static-mvapich2-1.9-gamma"
#EXEC="/opt/applic/vasp/bin/vasp-5.3.3-xe11-static-mvapich2-1.9-half"
#EXEC="/opt/applic/vasp/bin/vasp-5.3.5-if12-openmpi-1.8.1-full"
#EXEC="/opt/applic/vasp/bin/vasp-5.3.5-if12-openmpi-1.8.1-gamma"
#EXEC="/opt/applic/vasp/bin/vasp-5.3.5-if12-openmpi-1.8.1-half"
#EXEC= # for V_run.sh
export LD_LIBRARY_PATH=/opt/intel/composer_xe_2011_sp1.13.367/compiler/lib/intel64:/opt/intel/composer_xe_2011_sp1.13.367/mkl/lib/intel64:/opt/mpi/intel-12/openmpi-1.8.1/lib:$LD_LIBRARY_PATH
