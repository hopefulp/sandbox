...
def main():
    ...
    gatoms.add_argument('-s', '--sel_list', help="one atom species or index in POSCAR: Hf O Mo S O  0 1 2 not yet for 2-5")
    gatoms.add_argument('-i', '--sel_index', help="select atoms in atom index in POSCAR: 0 3 8 ")
