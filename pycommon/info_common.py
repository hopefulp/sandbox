...
dirjob.dir_fname    =   "Treat Dir without work-style\
                        ...
                        \n\t\t    -r  run without question\
                        \n\t\t    -re recursive for subdirectroies\
                        \n\t\t    -rs style=[ap:append, rp:replace, mo: mode\
                        ...
                        \n\t\tUsage::\
                        \n\t\t    dir_fname.py rename -p G4 -rs rp -rw G2 -id         ! rename with full replacement\
                        \n\t\t    dir_fname.py rename -p ToBeDelete_ -rs rp -re -r    ! without -rw, -p is deleted in fname\
                        \n\t\t    dir_fname.py rename -p G4 -rs ap -rw vdw -id        ! append new word after dir and fname\
