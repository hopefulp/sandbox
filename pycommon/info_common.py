...
dirs.dir_clean      ="====================== DIR Jobs =================\
                    \n\tClean Dirs following work kinds\
                    "
dirs.dir_fname      ="\n\tTreat Dirs without work style\
                    \n\tJobs: ls,mv,rm,rename,cp,chmod\
                    \n\t    mv: if target exists, it is skipped\
                    \n\tOptions:\
                    \n\t    -id include directory\
                    \n\tUsage::\
                    \n\t    $ dir_fname.py mv -p HfSe2sc34 -nd HFSe2sc34 -id\
                    "
clean.clean_dirs    ="\n\tDifference from dir_clean\
                    "
clean.clean_recur   ="\n\tClean dirs recurrsively\
                    "
howto.howto         ="===================== How to use :: This sandbox ===========\
                    \n\tRuns::\
                    \n\t    comment_sys.py\
                    \n\t    -s runs 'comment_subj.py'\
                    "
howto.showall       ="\n\tLinked to howto.py"
howto.command       ="\n\tShows basic command for several jobs\
                    \n\t    Jobs::\
                    \n\t\tvasp\
                    "
howto.comment_sys   ="\n\tshows system-related info"
howto.comment_subj  ="\n\tshows work-related info"

classobj_dict={'DIRS': dirs, 'CLEAN': clean, 'FNAME': fname} 
