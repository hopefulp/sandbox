...
build.build_struct  = "build STRUCT.fdf\
                    ...
                    \n\t\t    -n, --npoints         # of distance, 3 before r_eq, -n(10) between r_eq and r_max\
                    \n\t\t    -n, --npoints_left    # of distance, 3 before r_eq, -n(10) between r_eq and r_max\
                    \n\t\t    -o, --outdir          output directory (geometries)\
                    \n\t\t    -p, --prefix          filename prefix (mol) -> mol_001.fdf\
                    \n\t\tUsage::\
                    \n\t\t    build_struct.py -a H H  -np 10"
