...
def mplt_line(degeneracy, x, y, ehomo, s_tag, abspin):
    """
...
def mplt_ab_draw(nfile, fid, beta_tag, ab_tag, diction, e_homo):
    ...
    if nkeys == 1:
        ...
        mplt_line(1, x_3kinds[0], y, e_homo,0, 0)
        fid+=1
        #continue
    temp_ene=TEMP_ENE
    tag_last_draw="NO"
    ...
    for tup in l_dic:
        ...
        if temp_ene == v_ene:
            ...
            ### draw 3 plots if last ene and finish
                ...
                mplt_line(degen_eline, x_r, y, e_homo, beta_tag, ab_tag)
        ...
        ### Draw if energies are different 
            ...
            if i == nkeys:
                ...
                #print x_r
                mplt_line(1, x_r, y, e_homo, beta_tag, ab_tag )
        temp_ene=v_ene
        degen_eline = 1
