...
# Version updates:
- 160228: Function rewritten. (working)
...
ref: calculating atom distances (20160209)
    http://docs.scipy.org/doc/scipy-0.13.0/reference/generated/scipy.spatial.distance.pdist.html#scipy.spatial.distance.pdist
    http://docs.scipy.org/doc/numpy/reference/arrays.nditer.html
    http://stackoverflow.com/questions/22720864/efficiently-calculating-a-euclidean-distance-matrix-using-numpy
    http://stackoverflow.com/questions/1871536/euclidean-distance-between-points-in-two-different-numpy-arrays-not-within?rq=1
"""
...
def addsolvent(*args, **kwargs):
    ...
    size
    margin: inflate the unit cell by x angs
    density: add requested density of solvent
    total: add requested number of solvent mols
