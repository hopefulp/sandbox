...
my $ff_dir = "/home/noische/ff"; #change here as necessary
@ISA = qw(Exporter);
@EXPORT = ();
...
sub ReadFFs {
    ...
    for $i (@tmp) {
	    ...
	    $currFF = "AMBER";
            ...
            $rec = (
                        {
                            "FF"      => "/home/noische/ff/AMBER03_SPC.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 1 if (! defined($currFF) or $currFF eq "AMBER");
            ...
            $rec = (
                        {
                            "FF"      => "/home/noische/ff/AMBER_MBSC0.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 1 if (! defined($currFF) or $currFF eq "AMBER");
            ...
            $rec = (
                        {
                            "FF"      => "/home/noische/ff/charmm_par_all27_lipid.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            ...
            $rec = (
                        {
                            "FF"      => "/home/noische/ff/charmm_par_all27_prot_na.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 2 if (! defined($currFF) or $currFF eq "CHARMM");
            ...
            $rec = (
                        {
                            "FF"      => "/home/noische/MesoDNA/ff/MesoDNA.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 3;
