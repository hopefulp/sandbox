...
usage = """
%s xyz_file out_file
    xyz_file: this file contains atomic coordinates
    out_file: Atoms section will be written in this file.
""" % sys.argv[0]

if len(sys.argv) < 3:
    warnings.warn("You have to specify xyz_file and out_file!!")
    print(usage)
    sys.exit(0)
...
if not os.path.exists(xyz_file):
    raise IOError("Cannot find the xyz_file %s!" % xyz_file)
