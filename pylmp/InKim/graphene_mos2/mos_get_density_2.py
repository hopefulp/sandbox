...
def count_layer(bgf_file, trj_file, ff_file='', out_file=''):
    ...
    for t in tqdm.tqdm(timesteps, ncols=120, desc="Calculating graphene z positions"):
        ...
        avg_gra_z1 = bt.atoms_average(mybgf, 'atom.z', selection="'S_3a' in atom.ffType and atom.rNo == 1")
        avg_gra_z2 = bt.atoms_average(mybgf, 'atom.z', selection="'S_3b' in atom.ffType and atom.rNo == 2")
