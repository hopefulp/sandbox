...
set graphene_1 [atomselect top "resname GRA and resid 2"]
set graphene_2 [atomselect top "resname GRA and resid 1"]
...
append filename ".density.kwac.random.profile"
...
for { set fr 1 } { $fr <= $n_frames } { incr fr } {
    ...
    # z: thickness
    set z1avg [lavg [$graphene_1 get {z}]]
    set z2avg [lavg [$graphene_2 get {z}]]
