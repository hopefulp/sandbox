...
set graphene_1 [atomselect top "resname GRA and resid 1"]
set graphene_2 [atomselect top "resname GRA and resid 2"]

set all [atomselect top "all"]
set n_frames [molinfo top get numframes]
set vdw [expr "3.057430885/2"]
set margin 10.0
set avg_dist {}
set avg_eff_dist {}
set avg_density {}
...
for { set fr 1 } { $fr <= $n_frames } { incr fr } {
    ...
    set z1avg [lavg [$graphene_2 get {z}]]
    set z2avg [lavg [$graphene_1 get {z}]]
    ...
    while { $trial <= 50 } {
        ...
        unset x1 x2 dx y1 y2 dy area inside num_ow mass density area_density
        unset inside_ow
        incr trial
    }
