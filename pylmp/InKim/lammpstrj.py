...
class lammpstrj():
    ...
    def __init__(self, trj_file):
        ...
        if os.path.exists(self.data_file):
            nu.warn("Loading information from %s" % self.data_file)
            with open(self.data_file, 'r') as f:
                timemark = pickle.load(f)
                if timemark == time.ctime(os.path.getmtime(self.trj_file)):
                    nu.warn("Trajectory file %s is not modified after scan. Proof-reading.." % self.trj_file)
                    ...
                    nu.warn("Trajectory file %s is modified after scan. Reloading the information.." % self.trj_file)
    ...
    def split(self):
        ...
        with open(self.trj_file) as bigfile:
