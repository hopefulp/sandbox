...
usage = """
PEGDE_generator.py head tail monomer target_mw ff_file
...
def main():
	...
	tail = bgf.BgfFile(sys.argv[2]);
	monomer = bgf.BgfFile(sys.argv[3]);
	target_mw = float(sys.argv[4]);
	ff_file = sys.argv[5];
	...
	h1.REMARK.append("head " + sys.argv[1] + ", tail " + sys.argv[2] + ", monomer " + sys.argv[3] + ", Mw " + sys.argv[4] + ", ff " + sys.argv[5])
	h1.saveBGF('generated.bgf')
