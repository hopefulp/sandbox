...
### 2016. 11. 14 developing for homo-reference
### 2016. 11. 14 developing for selective line
...
for file in list_qchem_ofiles:
    ...
    while 1:
        ...
        ### found MO
            ...
            #print line
            # if found virtual
            if re.search(keyword_a_val, line):
                tag_lumo="YES"
            # in case beta
            elif line == '\n':
                pass
    ...
    fl_ene_lumo.append(e_lumo_tmp)
    fl_line_ene.append(line_ene)
### end of readline files
print "print 2: LUMO energy:: ", fl_ene_lumo
fl_list_ene=[]      # [ [e1, e2... ], [e1, e2...] [...
for fline in fl_line_ene: # [ [line1, line2,...], [line1, line2,...
    list_ene=[]
    for eline in fline:
    	#print eline,
...
print "print 3: orbital energies"
...
for list_ene in fl_list_ene:
    ...
    i=0
    multi_degen=1
    e_lumo=float(fl_ene_lumo[fid][0])
    #print "LUMO: ", e_lumo
    ### for H radical
    if len(list_ene) == 1:
