...
if($#ARGV < 0){
    print "Usage:: $0 pbs-psi.csh dirname vasp_exe\n";
    exit;
}elsif($#ARGV == 1){
    $fin="pbs-psi.csh";
    $dir=$ARGV[0];
...
$exe_string="set EXEC = \"/opt/applic/vasp/bin/vasp-5.3.3-xe11-static-openmpi-1.6.3-";
$exe_string_xy="set EXEC = \"/opt/applic/vasp/bin/xy-vasp-5.3.3-xe11-static-openmpi-1.6.3-";
switch ($exe_vasp){
