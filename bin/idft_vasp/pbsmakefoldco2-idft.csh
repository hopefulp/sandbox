...
set Me = $PBS_JOBNAME
set jobname = cpo27${Me}_a_6co2opt
set wdir = $jobname
...
cp $PBS_O_WORKDIR/${Me}-mof.pos.add6co2		$PBS_O_WORKDIR/$wdir/POSCAR
cp $PBS_O_WORKDIR/Pot/pawpbe_${Me}OCH.pot 	$PBS_O_WORKDIR/$wdir/POTCAR
cp $PBS_O_WORKDIR/incar.520.fine.6co2		$PBS_O_WORKDIR/$wdir/INCAR
