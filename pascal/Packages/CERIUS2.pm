...
my $scripts_dir = "/home/joonho/sandbox_gl/pascal"; #change here as necessary
my $ff_dir = "/home/joonho/Research/Lammps/ff"; #change here as necessary
@ISA = qw(Exporter);
@EXPORT = ();
...
sub ReadFFs {
    ...
    for $i (@tmp) {
	    ...
	    $currFF = "AMBER";
            ...
            $rec = (
                        {
                            "FF"      => "/home/tpascal/ff/AMBER03_SPC.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 1 if (! defined($currFF) or $currFF eq "AMBER");
            ...
            $rec = (
                        {
                            "FF"      => "/home/tpascal/ff/AMBER_MBSC0.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 1 if (! defined($currFF) or $currFF eq "AMBER");
            ...
            $rec = (
                        {
                            "FF"      => "/home/tpascal/ff/charmm_par_all27_lipid.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            ...
            $rec = (
                        {
                            "FF"      => "/home/tpascal/ff/charmm_par_all27_prot_na.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 2 if (! defined($currFF) or $currFF eq "CHARMM");
            ...
            $rec = (
                        {
                            "FF"      => "/home/tpascal/MesoDNA/ff/MesoDNA.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 3;
            ...
            $rec = (
                        {
                            "FF"      => "/home/tpascal/ff/DREIDING2.21.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 4;
