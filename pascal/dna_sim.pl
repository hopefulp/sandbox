...
#	die "Unable to create directory to store results. Aborting\n";
    ...
    $out_text = "cp -r /home/yjn1818/md_simulations/amber8_parallel/* .";
    DoCmd($out_text);
...
# --- Energy Analysis
	...
	$out_cmd = "/home/yjn1818/scripts/energy_anal_nonamot.pl $new_parm " .
...
# ---- Structure Analysis
	...
	$curr_dir = $out_cmd;
	$out_cmd = "/home/yjn1818/scripts/structure_anal.pl $new_parm " . $Parms->{"SaveName"} .
