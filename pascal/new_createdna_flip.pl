...
# now determine the number of atoms before the first turn
    ...
    -e "/home/yjn1818/scripts/function.pl" or die "Cannot locate file function.pl, so cannot calculate twist angles\n";

    open TWISTANGLE, "/home/yjn1818/scripts/function.pl $major_no $minor_no |" or die "Cannot execute function.pl";
    while (<TWISTANGLE>) {
	chomp;
