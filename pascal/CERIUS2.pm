...
sub loadConverter {
    my ($inFile) = "/home/yjn1818/scripts/dat/ceriusParms2Lammps.perldata";
    my (%SHASH);
...
sub getHbondList {
    ...
    my ($hbondList, $i, $j, $k, $iNum, $jNum, $dList, $aList, $hList, $rec);
...
sub parseCerius2FF {
    ...
    my ($donors, $acceptors, $hydrogens, $elements, $tmp);
...
sub ReadFFs {
    ...
    for $i (@tmp) {
	    ...
	    $currFF = "AMBER";
            ...
            $rec = (
                        {
                            "FF"      => "/home/yjn1818/ff/AMBER03_SPC.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 1 if (! defined($currFF) or $currFF eq "AMBER");
            ...
            $rec = (
                        {
                            "FF"      => "/home/yjn1818/ff/AMBER_MBSC0.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 1 if (! defined($currFF) or $currFF eq "AMBER");
            ...
            $rec = (
                        {
                            "FF"      => "/home/yjn1818/ff/charmm_par_all27_lipid.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            ...
            $rec = (
                        {
                            "FF"      => "/home/yjn1818/ff/charmm_par_all27_prot_na.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 2 if (! defined($currFF) or $currFF eq "CHARMM");
            ...
            $rec = (
                        {
                            "FF"      => "/home/yjn1818/MesoDNA/ff/MesoDNA.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 3;
            ...
            $rec = (
                        {
                            "FF"      => "/home/yjn1818/ff/DREIDING2.21.ff",
                            "FFTYPE"  => "CERIUS2",
                        }
                    );
            $ffType = 4;
...
sub loadElements {
    ...
    $myDir = "/home/yjn1818/scripts/Packages";
