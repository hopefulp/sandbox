...
BEGIN {
    push @INC, "/home/yjn1818/.libs/Math-ematica-1.108";
...
sub CreateCtlFile(@) {
    ...
    $out_cmd = "/home/yjn1818/scripts/amber2bgf.pl ";
    $out_cmd .= "$pdb_file /home/yjn1818/ff/AMBER95.cnv ";
    ...
    $out_cmd = "cp /home/yjn1818/mpsim/ewald.par .";
    if (! DoCmd($out_cmd)) {
	print "ERROR copying /home/yjn1818/mpsim/ewald.par\n";
    }

    open CTL, "/home/yjn1818/mpsim/1-pme.ctl" or die "Cannot open 1-pme.ctl: $!\n";
    while (<CTL>) {
	chomp;
	if ($_ =~ /\[p_name\]/) {
